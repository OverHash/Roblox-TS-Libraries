type notReleasedHandlerFunc = (placeId: number, gameJobId: string) => "Repeat" | "Cancel" | "ForceLoad";
type GlobalUpdateHandler = (globalUpdates: GlobalUpdates) => void;
type GlobalUpdateData = {
...
interface Profile<DataType extends Object> extends ViewProfile<DataType> {
	Data: DataType;
	MetaData: ProfileMetaData;
}

interface ViewProfile<DataType extends Object> {
	/**
...
interface ProfileStore {
	 ...
	 */
	LoadProfileAsync<Data extends Object>(
		profileKey: string,
...
declare namespace ProfileService {
	 ...
	 */
	const GetProfileStore: (profileStoreName: string, profileTemplate: Object) => ProfileStore;
}
